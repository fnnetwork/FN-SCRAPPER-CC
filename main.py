...
api_id = '28811010'  # Replace with your api id
...
async def anukarop(event):
    try:
        ...
        if re.search(r'(Approved!|Charged|authenticate_successful|𝗔𝗽𝗽𝗿𝗼𝘃𝗲𝗱|- 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 ✅|APPROVED|New Cards Found By Scrapper|ꕥ Extrap [☭]|• New Cards Found By ElectraOp>)', message.text):
            ...
            for card_info in filtered_card_info:
                ...
                if bin_info:
                    ...
                    # Format the message
                    formatted_message = (
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝐀𝐩𝐩𝐫𝗼𝐯𝗲𝐝 ✅\n\n"
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝗖𝗮𝗿𝗱: `{card_info}`\n"
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: Braintree Auth 4\n"
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝐑𝐞𝐬𝗽𝗼𝐧𝐬𝗲: `1000: Approved`\n\n"
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝗜𝗻𝗳𝗼: {brand} - {card_type} - {level}\n"
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝐈𝐬𝐬𝐮𝐞𝐫: {bank}\n"
                        f"**[-]**(t.me/+JylLXWo9nhRlZjEx) 𝐂𝗼𝐮𝐧𝐭𝐫𝐲: {country} {country_flag}\n\n"
